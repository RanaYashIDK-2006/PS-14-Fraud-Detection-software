...
def test_production_gate_missing_calibrator():
    ...
    try:
        ...
        exit_code = run_test("scripts/production_gate_test.py")
...
def test_leakage_detection():
    ...
    feature_registry = ROOT / "src" / "privacy_layer" / "feature_registry.py"
...
"""
    try:
        ...
        exit_code = run_test("scripts/leakage_structural_test.py")
...
def test_calibration_missing_artifacts():
    ...
    try:
        ...
        exit_code = run_test("scripts/calibration_test.py")
...
def test_raw_amount_detection():
    ...
    privacy_test = ROOT / "scripts" / "privacy_test.py"
...
def test_sql_injection_runs_clean():
    ...
    """
    exit_code = run_test("scripts/sql_injection_test.py")
...
def test_temporal_correctness():
    ...
    exit_code = run_test("scripts/temporal_test.py")
