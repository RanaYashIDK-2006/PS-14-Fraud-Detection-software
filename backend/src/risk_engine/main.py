...
ARTIFACTS_DIR = Path(__file__).resolve().parent.parent.parent.parent / "models" / "artifacts"
PRODUCTION_DIR = Path(__file__).resolve().parent.parent.parent.parent / "models" / "production"
